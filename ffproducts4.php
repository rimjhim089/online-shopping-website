...
#one{background-image: url(img/Women_Flats_4b.jpg);background-size: cover; }

#two{background-image: url(img/Women_Flats_4c.jpg); background-size: cover;}

#three{background-image: url(img/Women_Flats_4d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Women_Flats_4b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Women_Flats_4c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Women_Flats_4d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4>Department: Women</h4></li>
        <li><h4> Size: 7 UK</h4></li>
        <li><h4> Comfortable Sole</h4></li>
