...
#one{background-image: url(img/Capture4.2.PNG);background-size: cover; }

#two{background-image: url(img/Capture4.3.PNG); background-size: cover;}


#one:checked ~ .display-img{
    background-image: url(img/Capture4.2.PNG) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Capture4.3.PNG);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Sleeve Type: Regular Sleeve</h4></li>
        <li><h4>Composition: 30% Cotton, 65% Polyester, 5% Spandex</h4></li>
