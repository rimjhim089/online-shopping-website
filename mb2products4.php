...
#one{background-image: url(img/Men_TrackPants_4a.jpg);background-size: cover; }

#one:checked ~ .display-img{
    background-image: url(img/Men_TrackPants_4a.jpg) ;
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Perfect for Sports, Gym, Running or Nightwear</h4></li>
        <li><h4> 100% Poliester sans ornements</h4></li>
        <li><h4> Enjoy the easy fit and classic styling of these elastic-waist jersey trackpants from Aventura Outfitters</h4></li>
        <li><h4> Right side zipper pocket</h4></li>
        <li><h4> Care Instructions: Machine wash cold, tumble dry low, do not iron on print, do not bleach</h4></li>
        </ul>   
    </div>
