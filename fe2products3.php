...
#one{background-image: url(img/Kurti3.png);background-size: cover; }

#two{background-image: url(img/Kurti3.2.png); background-size: cover;}

#three{background-image: url(img/Kurti3.3.png);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Kurti3.png) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Kurti3.2.png);
}

#three:checked ~ .display-img{
    background-image: url(img/Kurti3.3.png);
}
