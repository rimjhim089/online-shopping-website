...
#one{background-image: url(img/Capture2.2.PNG);background-size: cover; }

#two{background-image: url(img/Capture2.3.PNG); background-size: cover;}

#three{background-image: url(img/Capture2.4.PNG);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Capture2.2.PNG) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Capture2.3.PNG);
}

#three:checked ~ .display-img{
    background-image: url(img/Capture2.4.PNG);
}
...
Color: Black</h4></li>
        ...
        <li><h4> Composition: 35% Cotton, 65% Spandex</h4></li>
