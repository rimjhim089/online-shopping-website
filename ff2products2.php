...
#one{background-image: url(img/Women_Heels_2b.jpg);background-size: cover; }

#two{background-image: url(img/Women_Heels_2c.jpg); background-size: cover;}

#three{background-image: url(img/Women_Heels_2d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Women_Heels_2b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Women_Heels_2c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Women_Heels_2d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4>Closure: Buckle</h4></li>
        <li><h4>Shoe Width: X-Wide</h4></li>
        <li><h4> Toe Style: Round Toe; Closure Type: Heels, Lifestyle: Casual/Partywear/Formal</h4></li>
        <li><h4> Speciality: Finest Quality, Durable, Lieght Weight And Comfortable To Wear</h4></li>
        <li><h4>TBalanced and Painless Base Sole</h4></li>
        <li><h4> Wash Care Instructions: Do not wash, use good quality brush or clean cloth to remove dirt from the surface.</h4></li>
