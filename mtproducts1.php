...
#one{background-image: url(img/Men_T-shirt_1a.jpg);background-size: cover; }

#two{background-image: url(img/Men_T-shirt_1b.jpg); background-size: cover;}

#three{background-image: url(img/Men_T-shirt_1c.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_1a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_1b.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_1c.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4>Care Instructions: Wash With Similar Colors, Use Detergent For Colors, Do Not Bleach, Dry Inside Out, Medium Iron With Steam, Do Not Iron On Prints</h4></li>
        <li><h4>Fit Type: Regular Fit</h4></li>
        <li><h4> Material And Quality: Soft And Smooth Skin Friendly Cotton Material Used And Well Stitched With Cotton Threads For Long Lasting</h4></li>
        <li><h4> Type Of Neck Style: Round Neck; Type Of Sleeves: Half Sleeve; Color: Maroon; Pattern: Printed T-shirts</h4></li>
        <li><h4> Design :- solid , trendy design , trendy look and optimal flaxibility</h4></li>
        <li><h4>Occasion: Casual Wear; Item Package Content: Valar Morghulis Printed 1 T-Shirt</h4></li>
        <li><h4> Pairing: Pair This Casual Half Sleeve T-shirts With Washed Jeans And Sneakers For Casual Look Or Wear With Matching Track Pant Or Short While Gym Or Jogging And Get Noticeable And Eye Catching Look</h4></li>
        <li><h4> Uses: Perfect For Each And Every Single Occasion Like Outing, Daily Wear, Office Wear, Casual Wear, Picnic, Birthday Parties, Hang Out And Can Be Ideal Gift For Your Friends & Family People
</h4></li>
      </ul>   
    </div>
