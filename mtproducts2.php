...
#one{background-image: url(img/Men_T-shirt_2a.jpg);background-size: cover; }

#two{background-image: url(img/Men_T-shirt_2b.jpg); background-size: cover;}

#three{background-image: url(img/Men_T-shirt_2c.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_2a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_2b.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_2c.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4>Care Instructions: Regular hand wash/machine wash, Do not bleach!</h4></li>
        <li><h4>Fit Type: Regular Fit</h4></li>
        <li><h4> Sleeve type: Half sleeve, Neck type: V-neck, Color: Multicolor.</h4></li>
        <li><h4> Material and quality: 100% Premium bio-washed soft and smooth skin friendly cotton material and well stitched with 100% cotton threads for long lasting use.</h4></li>
        <li><h4> Design and style: Trending color blocked color combination design with round neck pattern gives extra ordinary casual look.</h4></li>
        <li><h4> Pairing: Pair this casual half sleeve t-shirt with washed jeans and sneakers and get noticeable and eye catching look.</h4></li>
        <li><h4> Happy Shopping: As we use 100% cotton material, please follow wash-care instructions for long lasting use. Also, once go through product size chart for exact size match according to your body and prevent after purchase size issues.</h4></li>
