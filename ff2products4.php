...
#one{background-image: url(img/Women_Heels_4b.jpg);background-size: cover; }

#two{background-image: url(img/Women_Heels_4c.jpg); background-size: cover;}

#three{background-image: url(img/Women_Heels_4d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Women_Heels_4b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Women_Heels_4c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Women_Heels_4d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Pumps (Heels) wedgeswith synthetic material.</h4></li>
        <li><h4>Casual wear, Party wear, Evening nightout or style you carry on.</h4></li>
        <li><h4> Care Instructions - Surface dirt can be cleaned with a good quality brush or a damp cloth.</h4></li>
        <li><h4> Carry this comfort from house of denill.</h4></li>
        </ul>   
    </div>
