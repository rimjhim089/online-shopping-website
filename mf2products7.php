...
#one{background-image: url(img/Men_CasualShoes_3a.jpg);background-size: cover; }

#two{background-image: url(img/Men_CasualShoes_3b.jpg); background-size: cover;}



#one:checked ~ .display-img{
    background-image: url(img/Men_CasualShoes_3a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_CasualShoes_3b.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4>Sole: rubber</h4></li>
        <li><h4>Closure: Lace-Up</h4></li>
        <li><h4> Shoe Width: Medium</h4></li>
        <li><h4> Occasion Lifestyle :- ✅casual sports running gym training special needs ethnic and traditional for any seasons✔️</h4></li>
        <li><h4> Design :- solid , trendy design , trendy look and optimal flaxibility</h4></li>
        <li><h4> Speciality: ✅light weight and convenient✔️</h4></li>
        <li><h4> ✅Ultra thin layer of high abrasion rubber strategically placed on the outsole for targeted traction✔️</h4></li>
        <li><h4> NOTE : ✅FREE DELIVERY✔️
</h4></li>
      </ul>   
    </div>
