...
#one{background-image: url(img/Men_TrackPants_1a.jpg);background-size: cover; }

#two{background-image: url(img/Men_TrackPants_1b.jpg); background-size: cover;}

#three{background-image: url(img/Men_TrackPants_1c.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_TrackPants_1a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_TrackPants_1b.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_TrackPants_1c.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Fabric: 97% cotton, 3% elastane; Pre-washed Cotton Jogger Fabric to impart a softer texture to provide comfort with strength.</h4></li>
        <li><h4> Fit: Slim fit joggers for men, with the drawstring feature, that makes these men joggers, casual to wear and easily adjustable to your waist according to desired comfort.</h4></li>
        <li><h4> Style: Designed for comfort and great for all year round use.</h4></li>
        <li><h4> Proudly made in India.</h4></li>
        <li><h4> Care Instructions: Cold water machine wash. Do not bleach or wash with chlorine based detergent for these joggers for men</h4></li>
        </ul>   
    </div>
