...
#one{background-image: url(img/s1.jpg);background-size: cover; }
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4>Care Instructions: Hand Wash</h4></li>
        <li><h4>Material : Chiffon</h4></li>
        <li><h4> With Blouse Piece, Border: Golden of zari</h4></li>
        <li><h4> Saree : 5.5 Meter & 0.8 Meter Blouse Piece,weight 300gms</h4></li>
        <li><h4>Wash Care : Machine Or Normal Hand Wash In Cold Water.</h4></li>
