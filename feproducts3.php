...
#one{background-image: url(img/s3.jpg);background-size: cover; }
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4>Blouse - Soft net Sari , Viscose georgette</h4></li>
        <li><h4>Dry clean only</h4></li>
        <li><h4> mirror and pearl work border</h4></li>
        <li><h4> teamed with a sheer nude</h4></li>
        <li><h4>hand embellished blouse with vine border and mirror work.</h4></li>
