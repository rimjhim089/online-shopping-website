...
#one{background-image: url(img/Featurephone.png);background-size: cover; }
...
.fashion .shirt{
 ...
 <body>
     ...
     <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=49");
            $stmt -> execute();
    ...
    <div class="text3">
        <ul>
        <li><h4>Poly Ringtone, Mini-SIM</h4></li>
        <li><h4>1.52-inch TFT screen with 128x128 pixels resolution; Network: GSM (900/1,800MHz)</h4></li>
        <li><h4> Samsung proprietary operating system</h4></li>
        <li><h4> 800mAH battery providing talktime of 7 hours and standby time of 720 hourss</h4></li>
        <li><h4>1 year manufacturer warranty for device and 6 month manufacturer warranty for in-box accessories including batteries from the date of purchase</h4></li>
