...
#one{background-image: url(img/Men_Shirts_4a.jpg);background-size: cover; }

#two{background-image: url(img/Men_Shirts_4b.jpg); background-size: cover;}

#three{background-image: url(img/Men_Shirts_4c.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_Shirts_4a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_Shirts_4b.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_Shirts_4c.jpg);
}
...
.fashion .shirt{
 ...
 <body>
	...
	<li><h4>Color: Dustypink</h4></li>
        <li><h4> Shirt fabric : 100% Premium Cottton, Pre Washed for an extremely soft finish and Rich look</h4></li>
        <li><h4> Stylish Full Sleeve Casual Shirt</h4></li>
        <li><h4> Sleeve : full sleeves</h4></li>
        <li><h4> Best for casual & smart casual wear</h4></li>
        <li><h4> Wash Instruction: Machine Wash</h4></li>
      </ul>   
    </div>
