...
#one{background-image: url(img/Men_Jeans_2b.jpg);background-size: cover; }

#two{background-image: url(img/Men_Jeans_2c.jpg); background-size: cover;}

#three{background-image: url(img/Men_Jeans_2d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_Jeans_2b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_Jeans_2c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_Jeans_2d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Stylish Washed Jeans with Zip Fly & Buttoned Closure</h4></li>
        <li><h4> Cotton Blend with Stretch Fabric - To give you extra comfort and flexibility</h4></li>
        <li><h4> Slim Fit; Mid-Rise; Regular Length</h4></li>
        <li><h4> Washed Style ; Perfect for Casual, Evening & Party wear</h4></li>
        <li><h4> Wash Care - Mild Wash ; Wash dark colors separately Disclaimer</h4></li>
      </ul>   
    </div>
