...
#one{background-image: url(img/Men_Jeans_3a.jpg);background-size: cover; }

#two{background-image: url(img/Men_Jeans_3b.jpg); background-size: cover;}

#three{background-image: url(img/Men_Jeans_3d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_Jeans_3a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_Jeans_3b.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_Jeans_3d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4> Fit Type: skinny</h4></li>
        <li><h4> Colour : Grey</h4></li>
        <li><h4> 83% Cotton, 15% Polyester And 2% Elastane</h4></li>
        <li><h4> Zip fly with button closure</h4></li>
        <li><h4> Stretchable Jeans</h4></li>
