...
#one{background-image: url(img/Women_Flats_1b.jpg);background-size: cover; }

#two{background-image: url(img/Women_Flats_1c.jpg); background-size: cover;}

#three{background-image: url(img/Women_Flats_1d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Women_Flats_1b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Women_Flats_1c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Women_Flats_1d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Slip On:Open Toe::Party Wear::Daily Wear::Fashionable</h4></li>
