...
#one{background-image: url(img/Men_TrackPants_2a.jpg);background-size: cover; }

#two{background-image: url(img/Men_TrackPants_2b.jpg); background-size: cover;}

#three{background-image: url(img/Men_TrackPants_2d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_TrackPants_2a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_TrackPants_2b.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_TrackPants_2d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Fabric : Cotton</h4></li>
        <li><h4> Pattern : printed</h4></li>
        <li><h4> Colour : Grey with black</h4></li>
        <li><h4> Closure : Elastic</h4></li>
        <li><h4> Wash Instruction: Regular Machine Wash</h4></li>
        </ul>   
    </div>
