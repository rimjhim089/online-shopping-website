...
#one{background-image: url(img/Smartphone.png);background-size: cover; }
#two{background-image: url(img/Smartphone1.2.png);background-size: cover; }
#three{background-image: url(img/Smartphone1.3.png);background-size: cover; }
...
#two:checked ~ .display-img{
    background-image: url(img/Smartphone1.2.png) ;
}
#three:checked ~ .display-img{
    background-image: url(img/Smartphone1.3.png) ;
}
...
.fashion .shirt{
 ...
 <body>
     ...
     <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=50");
            $stmt -> execute();
    ...
    <div class="text3">
        <ul>
        <li><h4>13MP+5MP ultra-wide dual camera | 8MP f2.0 front camera</h4></li>
        <li><h4>16cm (6.3") Full HD+ Infinity V Display with 2340x1080 crystal clear resolution (409 PPI)</h4></li>
        <li><h4> 5000 mAh battery with 3x fast charge | 15W Type-C fast charger in the box</h4></li>
        <li><h4> 4GB RAM and 64GB internal memory expandable up to 512GB in a dedicated slot</h4></li>
        <li><h4>Fast face unlock and fingerprint sensor | Dual SIM (nano+nano) with dual standby and dual VoLTE</h4></li>
        <li><h4> Widevine L1 certification for HD streaming | Dolby ATMOS 360 surround sound</h4></li>
        <li><h4> 1.8GHz Exynos 7904 octa-core processor | Android Oreo v8.1 OS</h4></li>
        </ul>   
    </div>
