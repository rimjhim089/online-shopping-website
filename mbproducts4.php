...
#one{background-image: url(img/Men_Jeans_4a.jpg);background-size: cover; }

#two{background-image: url(img/Men_Jeans_4b.jpg); background-size: cover;}

#three{background-image: url(img/Men_Jeans_4d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_Jeans_4a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_Jeans_4b.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_Jeans_4d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Basic 5 pockets</h4></li>
        <li><h4> mid rise, regular length</h4></li>
