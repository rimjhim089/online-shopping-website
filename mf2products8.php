...
#one{background-image: url(img/Men_CasualShoes_4b.jpg);background-size: cover; }

#two{background-image: url(img/Men_CasualShoes_4c.jpg); background-size: cover;}

#three{background-image: url(img/Men_CasualShoes_4d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_CasualShoes_4b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_CasualShoes_4c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_CasualShoes_4d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Closure: Lace-Up</h4></li>
        <li><h4> Lifestyle: Casual / Daily Use</h4></li>
        <li><h4> Sole Material: Rubber Sole</h4></li>
        <li><h4> Attractive and Durable</h4></li>
        <li><h4> Product warranty against manufacturing defects: 30 days
</h4></li>
      </ul>   
    </div>
