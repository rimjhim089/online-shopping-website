...
#one{background-image: url(img/Women_Flats_2b.jpg);background-size: cover; }

#two{background-image: url(img/Women_Flats_2c.jpg); background-size: cover;}

#three{background-image: url(img/Women_Flats_2d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Women_Flats_2b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Women_Flats_2c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Women_Flats_2d.jpg);
}
