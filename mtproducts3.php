...
#one{background-image: url(img/Men_T-shirt_3b.jpg);background-size: cover; }

#two{background-image: url(img/Men_T-shirt_3c.jpg); background-size: cover;}

#three{background-image: url(img/Men_T-shirt_3d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_3b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_3c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_T-shirt_3d.jpg);
}
