...
<link rel="stylesheet" type="text/css" href="css/checkout1.css">
 ...
 <div class="container">
               ...
               <div class="table-responsive mt-2">
                   <table class="table table-bordered table-striped text-center">
                       ...
                       <tr>
                           ...
                           <th>Total price</th>
                           <th>
                               <a href="action3.php?clear=all" class="badge-danger badge p-1" onclick="return confirm('Are you sure to clear your cart?');"><i class="fa fa-trash"></i>&nbsp;&nbsp;Clear Cart</a>
                           </th>
    ...
    <tr>
                               ...
                               <td>
                                   <a href="action3.php?remove=<?= $row['pro_id'] ?>" class="text-danger" onclick="return confirm('Are you sure want to remove this item?');"><i class="fa fa-trash"></i></a>
                               </td>
                            </tr>
