...
#one{background-image: url(img/Kurti1.2.png);background-size: cover; }

#two{background-image: url(img/Kurti1.3.png); background-size: cover;}

#three{background-image: url(img/Kurti1.4.png);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Kurti1.2.png) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Kurti1.3.png);
}

#three:checked ~ .display-img{
    background-image: url(img/Kurti1.4.png);
}
...
.fashion .shirt{
 ...
 <body>
     ...
     <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=45");
            $stmt -> execute();
    ...
    <div class="text3">
        ...
        <li><h4>Style:	Casual
Color:	Blue</h4></li>
        <li><h4>Neckline:	Notched</h4></li>
        <li><h4> Type:	Tunic</h4></li>
        <li><h4> Sleeve Length:	Three Quarter Length Sleeve</h4></li>
        <li><h4>Fit Type:	Regular Fit</h4></li>
        <li><h4> Material:	Cotton Blends</h4></li>
        <li><h4> Placket Type:	Half Placket</h4></li>
        </ul>   
    </div>
...
<div class="midcon">
        ...
        <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=46");
            $stmt -> execute();
            $result = $stmt->get_result();
            while($row= $result->fetch_assoc()):
    ?>   
   ...
   <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=47");
            $stmt -> execute();
            $result = $stmt->get_result();
            while($row= $result->fetch_assoc()):
    ?>   
   ...
   <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=48");
            $stmt -> execute();
            $result = $stmt->get_result();
            while($row= $result->fetch_assoc()):
    ?>   
