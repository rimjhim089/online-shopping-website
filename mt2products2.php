...
#one{background-image: url(img/Men_Shirts_2a.jpg);background-size: cover; }

#two{background-image: url(img/Men_Shirts_2b.jpg); background-size: cover;}



#one:checked ~ .display-img{
    background-image: url(img/Men_Shirts_2a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_Shirts_2b.jpg);
}
...
.fashion .shirt{
 ...
 <body>
     ...
     <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=14");
            $stmt -> execute();
    ...
    <div class="text3">
        ...
        <li><h4>100% High-grade Cotton Fabrics: Good capability of tenderness, air permeability and moisture absorption feels soft and comfy.</h4></li>
        <li><h4> Suitable for: Sports, Casual, Business Work, Date, Party, Perfect gift for families, friends and boyfriend</h4></li>
        <li><h4> Slim Fit , Fabric: 100% Cotton , Full Sleeve ,Casual Shirts</h4></li>
        <li><h4> High Quality Fabric and Stitching</h4></li>
        <li><h4> Wash Instruction: Handwash in cold water NO BLEACH, Low iron and tumble dry on low heat</h4></li>
      </ul>   
    </div>
...
<div class="midcon">
        ...
        <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=13");
            $stmt -> execute();
            $result = $stmt->get_result();
            while($row= $result->fetch_assoc()):
    ?>   
   ...
   <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=15");
            $stmt -> execute();
            $result = $stmt->get_result();
            while($row= $result->fetch_assoc()):
    ?>   
   ...
   <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=16");
            $stmt -> execute();
            $result = $stmt->get_result();
            while($row= $result->fetch_assoc()):
    ?>   
