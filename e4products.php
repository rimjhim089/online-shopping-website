...
#one{background-image: url(img/pb.png);background-size: cover; }
#two{background-image: url(img/pb1.2.png);background-size: cover; }
...
#two:checked ~ .display-img{
    background-image: url(img/pb1.2.png) ;
}
...
.fashion .shirt{
 ...
 <body>
     ...
     <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=52");
            $stmt -> execute();
    ...
    <div class="text3">
        <ul>
        <li><h4>10000mAh Li-Polymer Battery: Mi Power Bank comes with high-density advanced Li-polymer batteries that makes it more durable and optimizes charging efficiency. It can charge Redmi Go - 2 times, Redmi K20 - 1.4 times, iPhone 8 - 3.5 times & iPad Mini - 1 time</h4></li>
        <li><h4>18W Fast Charging: The new Mi Power Bank 2i comes with a never heard before 18W Fast Charging. It supports 5V/2A, 9V/ 2A and 12V/1.5A charging outputs that ensures efficient and quick charging for your devices</h4></li>
        <li><h4> Stylish Aluminium Casing: Made using premium Aluminium Alloy with CNC Edge technology to give a perfect textured finish. The new 180° degree ergonomic design ensures a secure and comfortable hand-grip</h4></li>
        <li><h4> 9 Layers of Protection: Mi Power Bank comes with advanced level of chipset protection that ensures protection against short-circuit, over-current, over-voltage, over-charge & discharge, etc</h4></li>
        <li><h4>Dual USB Output with smart charging: Mi Power Bank 2i intelligently adjusts power output up to 18W to deliver fast and efficient charging for each connected device</h4></li>
        <li><h4> Two-way Quick Charge: The feature ensures faster charging for Power Bank and connected devices; Charging time: Approx 4.5 hours (18W charger, standard USB cable), Approx 6 hours ( 10W charger, standard USB cable)</h4></li>
        <li><h4> Universal Compatibility: Now charge not just mobiles but tablets, BT speakers, earphones, headsets, fitness bands etc</h4></li>
        </ul>   
    </div>
