...
#one{background-image: url(img/Men_SportShoes_4b.jpg);background-size: cover; }

#two{background-image: url(img/Men_SportShoes_4c.jpg); background-size: cover;}

#three{background-image: url(img/Men_SportShoes_4d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_SportShoes_4b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_SportShoes_4c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_SportShoes_4d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4>Sole: TPR</h4></li>
        <li><h4>Closure: Slip On</h4></li>
        <li><h4> Shoe Width: Medium</h4></li>
        <li><h4> Material Type: Mesh</h4></li>
        <li><h4> Lifestyle: Sports</h4></li>
        <li><h4>Warranty Type: Manufacturer</h4></li> 
        <li><h4> Product warranty against manufacturing defects: 30 days</h4></li>
        <li><h4> Care Instructions: Allow your pair of shoes to air and de-odorize at a regular basis, this also helps them retain their natural shape; use shoe bags to prevent any stains or mildew; dust any dry dirt from the surface using a clean cloth, do not use polish or shiner</h4></li>
