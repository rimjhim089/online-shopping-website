...
#one{background-image: url(img/Capture3.2.PNG);background-size: cover; }

#two{background-image: url(img/Capture3.3.PNG); background-size: cover;}

#three{background-image: url(img/Capture3.4.PNG);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Capture3.2.PNG) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Capture3.3.PNG);
}

#three:checked ~ .display-img{
    background-image: url(img/Capture3.4.PNG);
}
