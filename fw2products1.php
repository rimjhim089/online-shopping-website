...
#one{background-image: url(img/Jeans1.1.png);background-size: cover; }

#two{background-image: url(img/Jeans1.2.png); background-size: cover;}

#three{background-image: url(img/Jeans1.3.png);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Jeans1.1.png) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Jeans1.2.png);
}

#three:checked ~ .display-img{
    background-image: url(img/Jeans1.3.png);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4>Style: Casual
Color: Blue</h4></li>
        <li><h4>Details: Belted, Pocket</h4></li>
        <li><h4> Pant Length: Cropped</h4></li>
        <li><h4> Composition: 85% Cotton, 15% Polyester</h4></li>
        <li><h4>Material: Denim</h4></li>
        <li><h4> Fabric: Non-stretch</h4></li>
        <li><h4> Waist Type: Mid Waist</h4></li>
        <li><h4>Closure Type: Zipper Fly</h4></li>
