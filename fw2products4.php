...
#one{background-image: url(img/Jeans4.2.png);background-size: cover; }

#two{background-image: url(img/Jeans4.3.png); background-size: cover;}

#three{background-image: url(img/Jeans4.4.png);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Jeans4.2.png) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Jeans4.3.png);
}

#three:checked ~ .display-img{
    background-image: url(img/Jeans4.4.png);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4>Style: Casual
        Color: Black</h4></li>
        <li><h4>Pant Type: Tapered/Carrot</h4></li>
        ...
        <li><h4>Closure Type: Button Fly</h4></li>
        </ul>   
    </div>
