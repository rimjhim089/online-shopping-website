...
#one{background-image: url(img/Kurti2.png);background-size: cover; }

#two{background-image: url(img/Kurti2.2.png); background-size: cover;}


#one:checked ~ .display-img{
    background-image: url(img/Kurti2.png) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Kurti2.2.png);
}
...
<li><h4>Neckline:	Notched</h4></li>
        ...
        <li><h4> Waist Line:	Natural</h4></li>
        </ul>   
    </div>
