...
#one{background-image: url(img/Men_Shirts_1b.jpg);background-size: cover; }

#two{background-image: url(img/Men_Shirts_1c.jpg); background-size: cover;}

#three{background-image: url(img/Men_Shirts_1d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_Shirts_1b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_Shirts_1c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_Shirts_1d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4>Material - 75% Cotton and 25% Polyester</h4></li>
        <li><h4> Full sleeve shirt</h4></li>
        <li><h4> Collar style - Semi cut away collar; Cuff style - Single cuff</h4></li>
        <li><h4> Pattern - Solid Men’s Formal Shirt</h4></li>
        <li><h4> Machine wash warm, wash dark colors separately, do not bleach, tumble dry low, warm iron</h4></li>
	<li><h4> Made in India</h4></li>
      </ul>   
    </div>
