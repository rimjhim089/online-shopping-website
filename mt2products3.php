...
#one{background-image: url(img/Men_Shirts_3a.jpg);background-size: cover; }

#two{background-image: url(img/Men_Shirts_3b.jpg); background-size: cover;}

#three{background-image: url(img/Men_Shirts_3c.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_Shirts_3a.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_Shirts_3b.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_Shirts_3c.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4> Shirt fabric : Cotton</h4></li>
        <li><h4> blue color</h4></li>
        <li><h4> Sleeve : full sleeves</h4></li>
        <li><h4> spread collar</h4></li>
        <li><h4> Wash Instruction: Normal Machine Wash</h4></li>
      </ul>   
    </div>
