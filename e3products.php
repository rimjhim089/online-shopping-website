...
#one{background-image: url(img/headphones.png);background-size: cover; }
#two{background-image: url(img/headphones1.2.png);background-size: cover; }
...
#two:checked ~ .display-img{
    background-image: url(img/headphones1.2.png) ;
}
...
.fashion .shirt{
 ...
 <body>
     ...
     <?php
            include 'dbconn.php';
            $stmt = $conn->prepare("select * from products where pro_id=51");
            $stmt -> execute();
    ...
    <div class="text3">
        <ul>
        <li><h4>Primary kind of gaming headset, perfect for playing games, listening music, etc. Single 3.5mm Jack for sound and mic</h4></li>
        <li><h4>Soft cushion head-pad and ear-pad, as well as adjustable length hinges guarantee hours of gaming comfort</h4></li>
        <li><h4> Delivers clear sound and deep bass for real game, little smart in-line Remote Control for sound and mic</h4></li>
        <li><h4> Flexible microphone for exact positioning and mic with great sensitivity at picking up sounds, your partner can hear your words clearly</h4></li>
        <li><h4>For any product related queries contact_us on: [1800 31300 7700]</h4></li>
