...
#one{background-image: url(img/Men_CasualShoes_1b.jpg);background-size: cover; }

#two{background-image: url(img/Men_CasualShoes_1c.jpg); background-size: cover;}

#three{background-image: url(img/Men_CasualShoes_1d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Men_CasualShoes_1b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Men_CasualShoes_1c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Men_CasualShoes_1d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        <ul>
        <li><h4>Colour: Khaki</h4></li>
        <li><h4>Outer Material: Leather</h4></li>
        <li><h4> Closure Type: Lace-Up</h4></li>
        <li><h4> Heel type: flats</h4></li>
        <li><h4>Toe Style: Round Toe</h4></li>
        <li><h4> Warranty Type: Manufacturer</h4></li>
        <li><h4> Warranty Description: 90 days</h4></li>
        </ul>   
    </div>
