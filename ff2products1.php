...
#one{background-image: url(img/Women_Heels_1b.jpg);background-size: cover; }

#two{background-image: url(img/Women_Heels_1c.jpg); background-size: cover;}

#three{background-image: url(img/Women_Heels_1d.jpg);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Women_Heels_1b.jpg) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Women_Heels_1c.jpg);
}

#three:checked ~ .display-img{
    background-image: url(img/Women_Heels_1d.jpg);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4>Shoe Width: Narrow</h4></li>
        <li><h4> Return Policy 3 Days (After the delivered)</h4></li>
