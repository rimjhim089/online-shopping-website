...
#one{background-image: url(img/Jeans2.1.png);background-size: cover; }

#two{background-image: url(img/Jeans2.2.png); background-size: cover;}

#three{background-image: url(img/Jeans2.3.png);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/Jeans2.1.png) ;
}

#two:checked ~ .display-img{
    background-image: url(img/Jeans2.2.png);
}

#three:checked ~ .display-img{
    background-image: url(img/Jeans2.3.png);
}
...
.fashion .shirt{
 ...
 <body>
    ...
    <div class="text3">
        ...
        <li><h4>Style: Casual
        Color: Black</h4></li>
        <li><h4>Details: Ripped</h4></li>
        <li><h4> Pant Length: Long</h4></li>
        <li><h4>Composition: 100% Denim</h4></li>
        <li><h4>Fit Type: Skinny</h4></li>
        <li><h4> Fabric: High Stretch</h4></li>
