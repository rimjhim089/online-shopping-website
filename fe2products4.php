...
#one{background-image: url(img/kurta4.PNG);background-size: cover; }

#two{background-image: url(img/kurta4.2.PNG); background-size: cover;}

#three{background-image: url(img/kurta4.3.PNG);background-size: cover;}

#one:checked ~ .display-img{
    background-image: url(img/kurta4.PNG) ;
}

#two:checked ~ .display-img{
    background-image: url(img/kurta4.2.PNG);
}

#three:checked ~ .display-img{
    background-image: url(img/kurta4.3.PNG);
}
